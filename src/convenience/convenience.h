...
int nearest_gain(rx888_dev_t *dev, int target_gain);
...
int verbose_set_frequency(rx888_dev_t *dev, uint32_t frequency);
...
int verbose_direct_sampling(rx888_dev_t *dev, int on);
...
int verbose_offset_tuning(rx888_dev_t *dev);
...
int verbose_auto_gain(rx888_dev_t *dev);
...
int verbose_gain_set(rx888_dev_t *dev, int gain);
...
int verbose_ppm_set(rx888_dev_t *dev, int ppm_error);
...
int verbose_reset_buffer(rx888_dev_t *dev);
